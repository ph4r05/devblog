...
- TODO: lz4 optimal breakdown (dictionaries, not linked), max block size on frame., independent blocks
...
TODO: Checkpoints, image on blocks, structure of map file - example. do I have such mapping ? state.json!
